...
public class ServerGreeter extends Thread {
	...
	public void run() {
		...
		while (val == true) {	
			...
			try {
				...
				DataInputStream dis = (DataInputStream) socket2.getInputStream();
	...
	public static void main(String[] args) {
		...
		Thread tr = new Thread(() -> ServerGreeter gr = new ServerGreeter());
		tr.start();
	}
}
